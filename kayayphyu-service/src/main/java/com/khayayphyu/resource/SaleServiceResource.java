...
public interface SaleServiceResource {
	Boolean createSale(HttpServletRequest request, Sale sale);
	List<Sale> findBySaleBoId(HttpServletRequest request, String boId)throws ServiceUnavailableException;
